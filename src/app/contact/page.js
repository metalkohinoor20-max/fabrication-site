...
export const metadata = {
  ...
  keywords: 'contact fabrication services, get quote for ACP work, aluminium windows contact, glass partition delhi, metal fabrication contact, fabrication services noida, upvc windows gurgaon, metal kohinoor ,sonu fabricator, sonu fabrication',
  openGraph: {
